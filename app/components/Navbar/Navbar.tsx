                    ...
                    <div className="relative flex h-12 md:h-20 items-center justify-between">
                        <div className="flex flex-1 items-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="flex flex-shrink-0 items-center">
                                <div className="block h-12 w-40 lg:hidden text-2xl font-bold">SkillThrills<span className="font-bold">.</span></div>
                                <div className="hidden h-full w-full lg:block text-4xl font-bold">SkillThrills<span
                                    className="font-bold ">.</span></div>
                            </div>
